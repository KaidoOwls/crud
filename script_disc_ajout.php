<?php
    ...
    if ($title == Null || $price == Null || $year == Null|| $label == Null || $genre == Null || $artist == Null) {
 ...
 // S'il n'y a pas eu de redirection vers le formulaire (= si la vérification des données est ok) :
    ...
    try {
        ...
        $requete = $db->prepare("INSERT INTO disc (disc_title, disc_price,disc_year, disc_label, disc_genre, artist_id) VALUES (:title, :price, :year, :label, :genre, :artist);");
